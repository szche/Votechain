#from . import utils, Transfer, Vote, Block, logger
from . import logger, serialize, from_disk, to_disk
...
class Committee:
    ...
    def validate_vote(self, vote):
        ...
        issue_message = serialize(issue_transfer.public_key)
    ...
    def genesis_block(self):
        ...
        issue_votes = from_disk("airdrop.votechain")
        votes = []
        ...
        block.parties = {}
        parties_pubkeys = from_disk("voting_kit/parties.votechain")
